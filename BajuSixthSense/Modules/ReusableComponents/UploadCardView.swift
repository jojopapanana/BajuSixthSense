            ...
            Rectangle()
                ...
                .overlay(
                    VStack(alignment: .leading) {
                        HStack {
                            ...
                            VStack(alignment: .leading) {
                                HStack {
                                    ...
                                    Button {
                                        #warning("TO-DO: delete card functionality")
                                    } label: {
                                ...
                                DropDownMenu(options: typeOfClothes, selectedOptionIndex: $typeSelectedOptionIndex, showDropdown: $showTypeDropdown, selectedDefects: $selectedDefects, typeText: $typeText, colorText: $colorText, selectedDefectTexts: $defectText, dropdownType: "Type")
                                    .zIndex(4)
                                    .padding(.bottom, 6)
                                ...
                                DropDownMenu(options: colorOfClothes, menuWidth: 203, selectedOptionIndex: $colorSelectedOptionIndex, showDropdown: $showColorDropdown, selectedDefects: $selectedDefects, typeText: $typeText, colorText: $colorText, selectedDefectTexts: $defectText, dropdownType: "Color")
                                    .zIndex(3)
                            }
                            .foregroundStyle(.labelPrimary)
                        }
                        ...
                        DropDownMenu(options: defectofClothes, menuWidth: 329, selectedOptionIndex: $colorSelectedOptionIndex, showDropdown: $showDefectDropdown, selectedDefects: $selectedDefects, typeText: $typeText, colorText: $colorText, selectedDefectTexts: $defectText, dropdownType: "Defects")
                            .zIndex(3)
